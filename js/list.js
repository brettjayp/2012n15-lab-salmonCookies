...
//    During the transition form lists to table, the below are all appended with 'List'
var salesPike = document.getElementById('salesPikeList');
var salesSeaTac = document.getElementById('salesSeaTacList');
var salesSeattle = document.getElementById('salesSeattleList');
var salesCap = document.getElementById('salesCapList');
var salesAlki = document.getElementById('salesAlkiList');
